          ...
          <div class="container-fluid py-2">
              <div class="row">
                  <div class="col-12">
                      <div class="card my-4">
                          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                              <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                  <h6 class="text-white text-capitalize ps-3">Tableau des profils</h6>
                              </div>
                          </div>
                      ...
                      <a class="btn bg-gradient-dark mb-0" href="{{ route('profilecvs.create') }}"><i
                              class="material-symbols-rounded text-sm">add</i>&nbsp;&nbsp;Ajouter un profil</a>
                  </div>
              </div>
          </div>
      </main>
